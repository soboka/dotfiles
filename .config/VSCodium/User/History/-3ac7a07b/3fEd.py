...
keys = [
    ...
    # Multimedia Keys
    Key([], "XF86AudioRaiseVolume",lazy.spawn["pamixer -i 5", os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")], 
        desc="Increase Volume"),
    Key([], "XF86AudioLowerVolume",lazy.spawn["pamixer -d 5", os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")], 
        desc="Decrease Volume"),
    Key([], "XF86AudioMute",lazy.spawn["pamixer -t", os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")], 
        desc="Mute Volume"),
