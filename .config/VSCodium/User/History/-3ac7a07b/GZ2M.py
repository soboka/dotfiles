...
keys = [
    ...
    # Multimedia Keys
    Key([], "XF86AudioRaiseVolume",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")), 
        desc="Increase Volume"),
    Key([], "XF86AudioLowerVolume",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")), 
