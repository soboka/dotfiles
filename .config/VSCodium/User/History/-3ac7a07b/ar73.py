...
keys = [
    ...
    # Multimedia Keys
    Key([], "XF86AudioRaiseVolume",lazy.spawn[os.path.expanduser("~/.config/qtile/scripts/volumechange.sh"), pamixer -i 5], 
        desc="Increase Volume"),
    Key([], "XF86AudioLowerVolume",lazy.spawn[os.path.expanduser("~/.config/qtile/scripts/volumechange.sh"), pamixer -d 5], 
        desc="Decrease Volume"),
    Key([], "XF86AudioMute",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumechange.sh")), 
        desc="Mute Volume"),
