...
keys = [
    ...
    # Multimedia Keys
    Key([], "XF86AudioRaiseVolume",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumeup.sh")), 
        desc="Increase Volume"),
    Key([], "XF86AudioLowerVolume",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumedown.sh")), 
        desc="Decrease Volume"),
    Key([], "XF86AudioMute",lazy.spawn(os.path.expanduser("~/.config/qtile/scripts/volumemute.sh")), 
        desc="Mute Volume"),
